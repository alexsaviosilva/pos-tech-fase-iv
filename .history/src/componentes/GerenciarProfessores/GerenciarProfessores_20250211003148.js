      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.professorCard}>
            <Text style={styles.professorName}>{item.name} - {item.disciplina}</Text>
            <View style={styles.professorActions}>
              <TouchableOpacity onPress={() => navigation.navigate("EditarProfessor", { professor: item })} style={styles.iconButton}>
